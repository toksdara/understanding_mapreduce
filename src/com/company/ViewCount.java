...
public class ViewCount extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setNumReduceTasks(2); // Determines the number of reducers. This means 2 files at the output.

        job.setMapperClass(Map.class);
        job.setReducerClass(Reduce.class);

        job.setCombinerClass(Reduce.class); // Set the Combiner class to use the same logic we have in Reduce
